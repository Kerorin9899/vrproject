...
public class ControllerAcceleration : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //Vector3 acc = OVRInput.GetLocalControllerAcceleration(OVRInput.Controller.LTouch);
        Vector3 acc = OVRInput.GetLocalControllerAngularAcceleration(OVRInput.Controller.LTouch);
